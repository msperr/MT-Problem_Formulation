...
Let $\ds,\de$ be special vertices describing the source and sink of the vehicle flow.\fxnote{G task graph, Ghat extended task graph} We define the task graph as $\hat{G}=(\hat{V},\hat{A})$\fxnote{widehat}, where
\begin{align*}
