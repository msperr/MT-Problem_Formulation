...
\tikzset{
	>=stealth',
	rect/.style={rectangle, rounded corners, draw=black, text width=1cm, minimum height=0.7cm, text centered},
	circ/.style={circle, draw=black, text centered, minimum height=0.8cm},
	arrow/.style={->, shorten <=1pt, shorten >=1pt,},
	dummy/.style={rectangle, text centered, text width=1cm, minimum height=0.7cm},
	dummycirc/.style={circle, minimum height=0.8cm},
	box/.style={draw=black, inner sep=0.3cm, rectangle},
}
...
\include{tex/Implementation_Results}
