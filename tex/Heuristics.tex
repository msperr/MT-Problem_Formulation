...
Let $S$ be a solution that is created with the procedure of \Cref{sec:general_setting} and the respective partial solutions $S_i$ are feasible in $(\operatorname{SMILP}_i)$ for ${i\in[n]}$. Then $S$ is feasible in $\eqref{eq:SMILP}$.
